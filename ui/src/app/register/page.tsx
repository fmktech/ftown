...
export default function RegisterPage() {
  ...
  const toggleIcon = (visible: boolean) =>
    visible ? (
      ...
      <div className="w-full max-w-sm sm:max-w-md rounded-[var(--radius-md)] border border-[var(--border-muted)] bg-[var(--bg-surface)] p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <p id="password-help" className="mt-1 text-xs text-[var(--text-faint)]">
              Minimum 8 characters
            </p>
          </div>

          <div>
            <label htmlFor="confirmPassword" className="block text-sm text-[var(--text-secondary)] mb-1">
              Confirm Password
            </label>
            <div className="relative">
              <input
            ...
            {mismatch && (
              <p id="confirm-error" className="mt-1 text-xs text-[var(--status-error)]">
