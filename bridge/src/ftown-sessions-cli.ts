...
function parseLoopHarness(raw: string | undefined): LoopHarness {
  ...
  if (!['claude', 'cursor', 'codex', 'grok', 'pi', 'kimi-code', 'muse', 'opencode', 'shell'].includes(harness)) {
...
Loop create/update options:
  ...
  --shell <type>                claude | cursor | codex | grok | pi | kimi-code | muse | opencode | shell (default: claude)
  --workdir <path>              Working directory
